...
function (_Component) {
  ...
  function ReactCalendarTimeline(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDrawingStart", function () {
      _this.setState({
        drawingDependency: true
      });
    });

    _defineProperty(_assertThisInitialized(_this), "handleDrawingFinish", function () {
      _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "getContainerClassName", function () {
      var drawingClassName = _this.state.drawingDependency ? " rct-drawing-dependency-active" : '';
      var externalClassName = _this.props.className ? " ".concat(_this.props.className) : '';
      var hasSelectedItemClassName = _this.state.selectedItem ? " rct-has-selected-item" : '';
      return "react-calendar-timeline".concat(externalClassName).concat(drawingClassName).concat(hasSelectedItemClassName);
    });
