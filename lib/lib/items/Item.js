...
var _dependencyDrawing = require("../dependencies/dependency-drawing");

var _constants = require("../dependencies/constants.js");
...
function (_Component) {
  ...
  function Item(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getScrollRef", function () {
      return _this.props.scrollRef;
    });

    _defineProperty(_assertThisInitialized(_this), "getDependencyDrawingRef", function () {
      return _this.props.dependencyDrawingRef;
    });

    _defineProperty(_assertThisInitialized(_this), "onMouseDown", function (e) {
      if (_this.props.canDrawDependency && (e.target === _this.drawHandleRight || e.target === _this.drawHandleLeft)) {
        e.stopPropagation();
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "getDrawHandleLeftRef", function (el) {
      return _this.drawHandleLeft = el;
    });

    _defineProperty(_assertThisInitialized(_this), "getDrawHandleRightRef", function (el) {
      return _this.drawHandleRight = el;
    });

    _defineProperty(_assertThisInitialized(_this), "getDropZoneLeftRef", function (el) {
      return _this.dropZoneLeft = el;
    });

    _defineProperty(_assertThisInitialized(_this), "getDropZoneRightRef", function (el) {
      return _this.dropZoneRight = el;
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "getDrawProps", function () {
      return {
        left: {
          ref: _this.getDrawHandleLeftRef,
          'data-id': _this.itemId,
          'data-side': _constants.DEPENDENCY_DIRECTIONS.START
        },
        right: {
          ref: _this.getDrawHandleRightRef,
          'data-id': _this.itemId,
          'data-side': _constants.DEPENDENCY_DIRECTIONS.FINISH
        }
      };
    });

    _defineProperty(_assertThisInitialized(_this), "getDropProps", function () {
      return {
        left: {
          ref: _this.getDropZoneLeftRef,
          'data-side': _constants.DEPENDENCY_DIRECTIONS.START
        },
        right: {
          ref: _this.getDropZoneRightRef,
          'data-side': _constants.DEPENDENCY_DIRECTIONS.FINISH
        }
      };
    });
  ...
  _createClass(Item, [{
    ...
    key: "mountDrawDependency",
    value: function mountDrawDependency() {
      var _this3 = this;

      var itemDroppableClassName = 'rct-item-droppable';
      var dropzoneOptions = {
        ondragenter: function ondragenter(event) {
          if (event.relatedTarget.dataset.id !== _this3.itemId) {
        ...
        ondrop: function ondrop(event) {
          if (event.relatedTarget.dataset.id === _this3.itemId) return;
          event.target.classList.remove(itemDroppableClassName);

          if (_this3.props.onDependencyDraw) {
            _this3.props.onDependencyDraw({
      ...
      this.dropZoneLeft && (0, _interactjs["default"])(this.dropZoneLeft).dropzone(dropzoneOptions);
      this.dropZoneRight && (0, _interactjs["default"])(this.dropZoneRight).dropzone(dropzoneOptions);
      this.drawHandleRight && (0, _dependencyDrawing.initDragItemDependency)(this.drawHandleRight, this.getDependencyDrawingRef, this.getScrollRef, this.props.onDrawingStart, this.props.onDrawingFinish);
      this.drawHandleLeft && (0, _dependencyDrawing.initDragItemDependency)(this.drawHandleLeft, this.getDependencyDrawingRef, this.getScrollRef, this.props.onDrawingStart, this.props.onDrawingFinish);
      this.setState({
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var _this$state = this.state,
          interactMounted = _this$state.interactMounted,
          drawDependencyMounted = _this$state.drawDependencyMounted;
      ...
      if (this.item) {
        if (this.props.canDrawDependency && this.props.order && !drawDependencyMounted) {
      ...
      this.setState({
        ...
        drawDependencyMounted: drawDependencyMounted
      });
    }
  }, {
    key: "actualClick",
...
_defineProperty(Item, "propTypes", {
  ...
  canDrawDependency: _propTypes["default"].bool,
  ...
  dependencyDrawingRef: _propTypes["default"].object,
  onDrawingStart: _propTypes["default"].func,
  onDrawingFinish: _propTypes["default"].func,
  onDependencyDraw: _propTypes["default"].func,
