  ...
  _createClass(Item, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.canDrawDependency) {
        ...
        (0, _interactjs["default"])(this.item).dropzone({
          ...
          ondrop: function ondrop(event) {
            ...
            var middleOfItem = event.target.offsetLeft + event.target.offsetWidth / 2;
            var leftOffsetOfDrop = _this3.props.scrollRef.scrollLeft - (0, _domHelpers.getSumOffset)(_this3.props.scrollRef).offsetLeft + event.dragEvent.pageX;
            var dropSide = leftOffsetOfDrop > middleOfItem ? 'end' : 'start';
            event.target.classList.remove(itemDroppableClassName);

            if (_this3.props.onDependencyDrop) {
              _this3.props.onDependencyDrop({
        ...
        (0, _dependencyDrawing.initDragItemDependency)(this.drawHandleRight, this.getDependencyDrawingRef, this.getScrollRef);
        (0, _dependencyDrawing.initDragItemDependency)(this.drawHandleLeft, this.getDependencyDrawingRef, this.getScrollRef);
      }
    }
  }, {
...
_defineProperty(Item, "propTypes", {
  ...
  onDependencyDrop: _propTypes["default"].func
});
