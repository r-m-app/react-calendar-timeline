...
var _Dependency = _interopRequireDefault(require("../dependencies/Dependency"));

var _DrawingPath = _interopRequireDefault(require("../dependencies/DrawingPath"));
...
function (_Component) {
  ...
  function Items() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getDependencyDrawingRef", function (el) {
      return _this.dependencyDrawingRef = el;
    });
  ...
  _createClass(Items, [{
    ...
    value: function render() {
      ...
      var groupedDependencies = dependencies ? groupDependenciesByVisibleItems(dependencies, sortedDimensionItems) : {};
      return _react["default"].createElement("div", {
        ...
        return _react["default"].createElement(_Item["default"], {
          ...
          canDrawDependency: _this2.props.canDrawDependency,
          ...
          dependencyDrawingRef: _this2.dependencyDrawingRef,
          onDrawingStart: _this2.props.onDrawingStart,
          onDrawingFinish: _this2.props.onDrawingFinish,
          onDependencyDraw: _this2.props.onDependencyDraw,
          hiddenDependencies: groupedDependencies[(0, _generic._get)(item, itemIdKey)]
        });
      }), dependencies && dependencies.filter(function (d) {
        return isVisibleDimensionItem(sortedDimensionItems, d.fromId) && isVisibleDimensionItem(sortedDimensionItems, d.toId);
      }).map(function (dependency) {
        return _react["default"].createElement(_Dependency["default"], {
          key: dependency.id,
          dependency: dependency,
          fromDimensionItem: sortedDimensionItems[dependency.fromId],
          toDimensionItem: sortedDimensionItems[dependency.toId],
          onClick: _this2.props.onDependencyClick,
          selectedZIndex: _this2.props.selectedDependencyZIndex
        });
      }), _react["default"].createElement(_DrawingPath["default"], {
...
_defineProperty(Items, "propTypes", {
  ...
  onDependencyClick: _propTypes["default"].func,
  onDrawingStart: _propTypes["default"].func,
  onDrawingFinish: _propTypes["default"].func,
  onDependencyDraw: _propTypes["default"].func,
  drawingPathColor: _propTypes["default"].string,
  selectedDependencyZIndex: _propTypes["default"].number,
...
function isVisibleDimensionItem(dimensionItems, itemId) {
  ...
  var order = dimensionItems[itemId].dimensions.order;
  return order !== undefined && order !== null;
}

function groupDependenciesByVisibleItems(dependencies, dimensionItems) {
  return dependencies.reduce(function (acc, d) {
    if (isVisibleDimensionItem(dimensionItems, d.fromId) && isVisibleDimensionItem(dimensionItems, d.toId)) return acc;
