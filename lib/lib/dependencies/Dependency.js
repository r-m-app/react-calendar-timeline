...
function (_React$PureComponent) {
  ...
  _createClass(Dependency, [{
    ...
    value: function render() {
      ...
      var dX = 80;
      var dY = 14;
      var svgStyles = calculateSvgStyles(coords, dX, dY, this.state.isSelected, this.props.selectedZIndex);
...
_defineProperty(Dependency, "propTypes", {
  ...
  selectedZIndex: _propTypes["default"].number,
...
function calculatePathCoords(fromItem, toItem, fromSide, toSide) {
  var X1 = fromSide === _constants.DEPENDENCY_DIRECTIONS.START ? fromItem.dimensions.left : fromItem.dimensions.left + fromItem.dimensions.width;
  var Y1 = fromItem.dimensions.top + fromItem.dimensions.height / 2;
  var X2 = toSide === _constants.DEPENDENCY_DIRECTIONS.START ? toItem.dimensions.left : toItem.dimensions.left + toItem.dimensions.width;
...
function calculateSvgStyles(_ref, dX, dY, isSelected) {
  var X1 = _ref.X1,
      ...
      X2 = _ref.X2,
      Y2 = _ref.Y2;
  var selectedZIndex = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 90;
...
function drawDependencyPath(_ref2, width, height, dX, dY, fromSide, toSide) {
  ...
  var arrowWidth = 11;
  var cDX = 40;
  var reverseStart = isSameSide && fromSide === _constants.DEPENDENCY_DIRECTIONS.START ? true : fromSide === _constants.DEPENDENCY_DIRECTIONS.START;
  var reverseEnd = isSameSide && toSide === _constants.DEPENDENCY_DIRECTIONS.FINISH ? true : toSide === _constants.DEPENDENCY_DIRECTIONS.FINISH;
